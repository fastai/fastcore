...
__all__ = ['test_sig', 'FixSigMeta', 'PrePostInitMeta', 'AutoInit', 'NewChkMeta', 'BypassNewMeta', 'empty2none',
           'anno_dict', 'get_kwargs_dict', 'use_kwargs_dict', 'use_kwargs', 'delegates', 'method', 'funcs_kwargs']
...
def _wrap(wrapped_f,keep=False):
    ...
    def _f(f,wrap=None):
        ...
        return f
    return partial(_f,wrap=wrapped_f)
...
def use_kwargs_dict(keep=False,wrap=False, **kwargs):
    ...
    def _f(f):
        ...
        return f
    return _wrap(_f,keep=keep) if wrap else _f
