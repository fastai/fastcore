...
__all__ = ['dict2obj', 'repr_dict', 'is_listy', 'shufflish', 'mapped', 'IterLen', 'ReindexCollection', 'open_file',
           'save_pickle', 'load_pickle', 'maybe_open', 'image_size', 'bunzip', 'join_path_file', 'loads', 'untar_dir',
           'repo_details', 'run', 'stringfmt_names', 'PartialFormatter', 'partial_format', 'trace', 'round_multiple',
