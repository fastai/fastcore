#AUTOGENERATED! DO NOT EDIT! File to edit: dev/03_dispatch.ipynb (unless otherwise specified).

__all__ = ['type_hints', 'anno_ret', 'cmp_instance', 'TypeDispatch', 'DispatchReg', 'typedispatch', 'cast',
           'retain_type', 'retain_types']
...
#Cell
def _retain_meta(x, res):
    if hasattr(x, '_meta') and hasattr(res,'set_meta'): res.set_meta(**x._meta)
