# AUTOGENERATED! DO NOT EDIT! File to edit: dev/02_utils.ipynb (unless otherwise specified).

__all__ = ['ifnone', 'maybe_attr', 'basic_repr', 'get_class', 'mk_class', 'wrap_class', 'store_attr', 'attrdict',
           'properties', 'camel2snake', 'snake2camel', 'class2attr', 'hasattrs', 'tuplify', 'detuplify', 'replicate',
           'uniqueify', 'setify', 'merge', 'is_listy', 'range_of', 'groupby', 'first', 'shufflish', 'IterLen',
           'ReindexCollection', 'lt', 'gt', 'le', 'ge', 'eq', 'ne', 'add', 'sub', 'mul', 'truediv', 'is_', 'is_not',
           'Inf', 'true', 'stop', 'gen', 'chunked', 'show_title', 'ShowTitle', 'Int', 'Float', 'Str', 'num_methods',
