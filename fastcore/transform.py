#AUTOGENERATED! DO NOT EDIT! File to edit: dev/04.transform.ipynb (unless otherwise specified).

__all__ = ['Transform', 'InplaceTransform', 'TupleTransform', 'ItemTransform', 'get_func', 'Func', 'Sig',
